...
namespace Error {
	ERROR errors[ERROR_MAX_ENTRY] = {
		...
		ERROR_ENTRY_NODEF(203),ERROR_ENTRY(204, "Лексический анализатор: Запрещенное имя идентификатора"),
		...
		ERROR_ENTRY(319, "Семантическая ошибка: Оператор switch обязан содержать ветку default"),
