...
// !!! ИСПРАВЛЕНО: Binary (0b101)
// Теперь корректно переходит в финальное состояние
#define FST_BINLIT 4, \
...
#define FST_STRLIT 4,	\
    ...
    FST::RELATION('z', 1), FST::RELATION('1', 1), FST::RELATION('2', 1), FST::RELATION('3', 1), FST::RELATION('4', 1), \
    FST::RELATION('5', 1), FST::RELATION('6', 1), FST::RELATION('7', 1), FST::RELATION('8', 1), FST::RELATION('9', 1), \
    FST::RELATION('0', 1), FST::RELATION(' ', 1), FST::RELATION('!', 1), FST::RELATION('?', 1), FST::RELATION(',', 1), \
...
#define FST_TWOPOINT FST_OPERATOR
