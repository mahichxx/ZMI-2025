...
// !!! ÑÈÌÂÎËÛ (CHAR) Ñ ÏÎÄÄÅÐÆÊÎÉ ÐÓÑÑÊÎÃÎ !!!
#define FST_CHARLIT 4, \
    ...
    FST::NODE(322, \
        ...
        FST::RELATION('Å', 2), FST::RELATION('¨', 2), FST::RELATION('Æ', 2), FST::RELATION('Ç', 2), FST::RELATION('È', 2), \
        FST::RELATION('É', 2), FST::RELATION('Ê', 2), FST::RELATION('Ë', 2), FST::RELATION('Ì', 2), FST::RELATION('Í', 2), \
        FST::RELATION('Î', 2), FST::RELATION('Ï', 2), FST::RELATION('Ð', 2), FST::RELATION('Ñ', 2), FST::RELATION('Ò', 2), \
        FST::RELATION('Ó', 2), FST::RELATION('Ô', 2), FST::RELATION('Õ', 2), FST::RELATION('Ö', 2), FST::RELATION('×', 2), \
        FST::RELATION('Ø', 2), FST::RELATION('Ù', 2), FST::RELATION('Ú', 2), FST::RELATION('Û', 2), FST::RELATION('Ü', 2), \
